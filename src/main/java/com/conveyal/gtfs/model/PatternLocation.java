 ...
 * all visit the same stops in the same sequence. Some of these characteristics, e.g., location ID, stop sequence, pickup
...
public class PatternLocation extends Entity {
    ...
    public double shape_dist_traveled; // FLEX TODO: do we need this?
     ...
     * {@link com.conveyal.gtfs.loader.Table#PATTERN_LOCATION}. JDBC prepared statement parameters use a one-based index.
     */
    @Override
